 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ge(Cg,Pg,"app");const Sg={apiKey:"AIzaSyDNZCXCOGwTjyYXCzDLKGEr7dzj7XKvFNk",authDomain:"drents-elftal.firebaseapp.com",projectId:"drents-elftal",storageBucket:"drents-elftal.firebasestorage.app",messagingSenderId:"542166909378",appId:"1:542166909378:web:1c3cd5336f6168067c965b",measurementId:"G-1F8PEJ34WQ"},Vg=Ol(Sg),pc=rg(Vg);async function Dg(n){const t=sc(pc,"teams"),e=gg(t,_g("email","==",n));return!(await Ag(e)).empty}async function kg(n,t,e){try{if(await Dg(t))throw new Error("Je hebt al gestemd met dit e-mailadres.");const s={players:n,email:t,allowNewsletter:e,submittedAt:new Date};return(await bg(sc(pc,"teams"),s)).id}catch(r){throw console.error("Error submitting team:",r),r}}function wl(n){let t;return{c(){t=B("div"),t.textContent="Bedankt voor je stem! Je elftal is succesvol opgeslagen.",D(t,"class","success-message svelte-1m9rzzk")},m(e,r){nt(e,t,r)},d(e){e&&et(t)}}}function Ng(n){let t;return{c(){t=ht("Verstuur je stem")},m(e,r){nt(e,t,r)},d(e){e&&et(t)}}}function Mg(n){let t;return{c(){t=ht("Versturen...")},m(e,r){nt(e,t,r)},d(e){e&&et(t)}}}function Og(n){let t,e,r,s,o,a,u,h,f,m,E,v,A,C,N,S,O,F,M=n[5]&&wl();function Y(g,p){return g[3]?Mg:Ng}let G=Y(n),x=G(n),w={};return E=new fh({props:w}),n[11](E),E.$on("playersUpdate",n[8]),A=new _h({props:{isOpen:n[0],isSubmitting:n[3],submitError:n[4]}}),A.$on("close",n[12]),A.$on("submit",n[9]),N=new Ih({props:{isOpen:n[1],players:n[7]}}),{c(){t=B("main"),e=B("div"),e.innerHTML='<h1 class="svelte-1m9rzzk">Drents Elftal</h1> <p class="subtitle svelte-1m9rzzk">Create your best eleven</p>',r=W(),M&&M.c(),s=W(),o=B("div"),a=B("button"),x.c(),h=W(),f=B("div"),m=B("div"),Ir(E.$$.fragment),v=W(),Ir(A.$$.fragment),C=W(),Ir(N.$$.fragment),D(e,"class","header svelte-1m9rzzk"),D(a,"class","submit-button svelte-1m9rzzk"),a.disabled=u=!n[2]||n[3],D(o,"class","controls svelte-1m9rzzk"),D(m,"class","pitch-section svelte-1m9rzzk"),D(f,"class","container svelte-1m9rzzk"),D(t,"class","svelte-1m9rzzk")},m(g,p){nt(g,t,p),k(t,e),k(t,r),M&&M.m(t,null),k(t,s),k(t,o),k(o,a),x.m(a,null),k(t,h),k(t,f),k(f,m),Cn(E,m,null),k(t,v),Cn(A,t,null),k(t,C),Cn(N,t,null),S=!0,O||(F=lt(a,"click",n[10]),O=!0)},p(g,[p]){g[5]?M||(M=wl(),M.c(),M.m(t,s)):M&&(M.d(1),M=null),G!==(G=Y(g))&&(x.d(1),x=G(g),x&&(x.c(),x.m(a,null))),(!S||p&12&&u!==(u=!g[2]||g[3]))&&(a.disabled=u);const y={};E.$set(y);const T={};p&1&&(T.isOpen=g[0]),p&8&&(T.isSubmitting=g[3]),p&16&&(T.submitError=g[4]),A.$set(T);const I={};p&2&&(I.isOpen=g[1]),p&128&&(I.players=g[7]),N.$set(I)},i(g){S||(Rn(E.$$.fragment,g),Rn(A.$$.fragment,g),Rn(N.$$.fragment,g),S=!0)},o(g){wr(E.$$.fragment,g),wr(A.$$.fragment,g),wr(N.$$.fragment,g),S=!1},d(g){g&&et(t),M&&M.d(),x.d(),n[11](null),Pn(E),Pn(A),Pn(N),O=!1,F()}}}function Lg(n,t,e){let r=!1,s=!1,o=!1,a={},u=!1,h=null,f=!1,m,E={},v="",A=!1;function C(M){e(2,o=M.detail.filledPositions===11),a=M.detail.players}async function N(){if(!u){e(3,u=!0),e(4,h=null);try{await kg(a,v,A),e(5,f=!0),e(0,r=!1),e(7,E={...a}),e(1,s=!0),v="",A=!1,setTimeout(()=>{e(5,f=!1),e(3,u=!1)},3e3)}catch(M){console.error("Error submitting team:",M),e(4,h=M instanceof Error?M.message:"Er is iets misgegaan bij het versturen. Probeer het later opnieuw."),e(3,u=!1)}}}const S=()=>e(0,r=!0);function O(M){Vr[M?"unshift":"push"](()=>{m=M,e(6,m)})}return[r,s,o,u,h,f,m,E,C,N,S,O,()=>e(0,r=!1)]}class Fg extends $n{constructor(t){super(),zn(this,t,Lg,Og,qn,{})}}new Fg({target:document.getElementById("app")});
