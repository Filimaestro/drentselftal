 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ge(Cg,Pg,"app");const Sg={apiKey:"AIzaSyDNZCXCOGwTjyYXCzDLKGEr7dzj7XKvFNk",authDomain:"drents-elftal.firebaseapp.com",projectId:"drents-elftal",storageBucket:"drents-elftal.firebasestorage.app",messagingSenderId:"542166909378",appId:"1:542166909378:web:1c3cd5336f6168067c965b",measurementId:"G-1F8PEJ34WQ"},Vg=Ol(Sg),pc=rg(Vg);async function Dg(n){const t=sc(pc,"teams"),e=gg(t,_g("email","==",n));return!(await Ag(e)).empty}async function kg(n,t,e){try{if(await Dg(t))throw new Error("Je hebt al gestemd met dit e-mailadres.");const s={players:n,email:t,allowNewsletter:e,submittedAt:new Date};return(await bg(sc(pc,"teams"),s)).id}catch(r){throw console.error("Error submitting team:",r),r}}function wl(n){let t;return{c(){t=B("div"),t.textContent="Bedankt voor je stem! Je elftal is succesvol opgeslagen.",D(t,"class","success-message svelte-1m9rzzk")},m(e,r){nt(e,t,r)},d(e){e&&et(t)}}}function Ng(n){let t;return{c(){t=ht("Verstuur je stem")},m(e,r){nt(e,t,r)},d(e){e&&et(t)}}}function Mg(n){let t;return{c(){t=ht("Versturen...")},m(e,r){nt(e,t,r)},d(e){e&&et(t)}}}function Og(n){let t,e,r,s,o,a,u,h,f,m,E,v,A,C,N,S,M,F,O=n[4]&&wl();function Y(g,p){return g[3]?Mg:Ng}let G=Y(n),x=G(n),w={};return E=new fh({props:w}),n[10](E),E.$on("playersUpdate",n[7]),A=new _h({props:{isOpen:n[0],isSubmitting:n[3],submitError:Lg}}),A.$on("close",n[11]),A.$on("submit",n[8]),N=new Ih({props:{isOpen:n[1],players:n[6]}}),{c(){t=B("main"),e=B("div"),e.innerHTML='<h1 class="svelte-1m9rzzk">Drents Elftal</h1> <p class="subtitle svelte-1m9rzzk">Create your best eleven</p>',r=W(),O&&O.c(),s=W(),o=B("div"),a=B("button"),x.c(),h=W(),f=B("div"),m=B("div"),Ir(E.$$.fragment),v=W(),Ir(A.$$.fragment),C=W(),Ir(N.$$.fragment),D(e,"class","header svelte-1m9rzzk"),D(a,"class","submit-button svelte-1m9rzzk"),a.disabled=u=!n[2]||n[3],D(o,"class","controls svelte-1m9rzzk"),D(m,"class","pitch-section svelte-1m9rzzk"),D(f,"class","container svelte-1m9rzzk"),D(t,"class","svelte-1m9rzzk")},m(g,p){nt(g,t,p),k(t,e),k(t,r),O&&O.m(t,null),k(t,s),k(t,o),k(o,a),x.m(a,null),k(t,h),k(t,f),k(f,m),Cn(E,m,null),k(t,v),Cn(A,t,null),k(t,C),Cn(N,t,null),S=!0,M||(F=lt(a,"click",n[9]),M=!0)},p(g,[p]){g[4]?O||(O=wl(),O.c(),O.m(t,s)):O&&(O.d(1),O=null),G!==(G=Y(g))&&(x.d(1),x=G(g),x&&(x.c(),x.m(a,null))),(!S||p&12&&u!==(u=!g[2]||g[3]))&&(a.disabled=u);const y={};E.$set(y);const T={};p&1&&(T.isOpen=g[0]),p&8&&(T.isSubmitting=g[3]),A.$set(T);const I={};p&2&&(I.isOpen=g[1]),p&64&&(I.players=g[6]),N.$set(I)},i(g){S||(Rn(E.$$.fragment,g),Rn(A.$$.fragment,g),Rn(N.$$.fragment,g),S=!0)},o(g){wr(E.$$.fragment,g),wr(A.$$.fragment,g),wr(N.$$.fragment,g),S=!1},d(g){g&&et(t),O&&O.d(),x.d(),n[10](null),Pn(E),Pn(A),Pn(N),M=!1,F()}}}let Lg=null;function Fg(n,t,e){let r=!1,s=!1,o=!1,a={},u=!1,h=!1,f,m={},E="",v=!1;function A(F){e(2,o=F.detail.filledPositions===11),a=F.detail.players}async function C(){if(!u){e(3,u=!0);try{await kg(a,E,v),e(4,h=!0),e(0,r=!1),e(6,m={...a}),e(1,s=!0),E="",v=!1,setTimeout(()=>{e(4,h=!1),e(3,u=!1)},3e3)}catch(F){console.error("Error submitting team:",F),e(3,u=!1)}}}const N=()=>e(0,r=!0);function S(F){Vr[F?"unshift":"push"](()=>{f=F,e(5,f)})}return[r,s,o,u,h,f,m,A,C,N,S,()=>e(0,r=!1)]}class xg extends $n{constructor(t){super(),zn(this,t,Fg,Og,qn,{})}}new xg({target:document.getElementById("app")});
