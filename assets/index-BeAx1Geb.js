 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ge(Cg,Pg,"app");const Sg={apiKey:"AIzaSyDNZCXCOGwTjyYXCzDLKGEr7dzj7XKvFNk",authDomain:"drents-elftal.firebaseapp.com",projectId:"drents-elftal",storageBucket:"drents-elftal.firebasestorage.app",messagingSenderId:"542166909378",appId:"1:542166909378:web:1c3cd5336f6168067c965b",measurementId:"G-1F8PEJ34WQ"},Vg=Ol(Sg),pc=rg(Vg);async function Dg(n){const t=sc(pc,"teams"),e=gg(t,_g("email","==",n));return!(await Ag(e)).empty}async function kg(n,t,e){try{if(await Dg(t))throw new Error("Je hebt al gestemd met dit e-mailadres.");const s={players:n,email:t,allowNewsletter:e,submittedAt:new Date};return(await bg(sc(pc,"teams"),s)).id}catch(r){throw console.error("Error submitting team:",r),r}}function wl(n){let t;return{c(){t=B("div"),t.textContent="Bedankt voor je stem! Je elftal is succesvol opgeslagen.",D(t,"class","success-message svelte-1m9rzzk")},m(e,r){nt(e,t,r)},d(e){e&&et(t)}}}function Ng(n){let t;return{c(){t=ht("Verstuur je stem")},m(e,r){nt(e,t,r)},d(e){e&&et(t)}}}function Mg(n){let t;return{c(){t=ht("Versturen...")},m(e,r){nt(e,t,r)},d(e){e&&et(t)}}}function Og(n){let t,e,r,s,o,a,u,h,f,m,E,v,A,C,M,S,N,F,O=n[3]&&wl();function Y(g,p){return g[2]?Mg:Ng}let G=Y(n),x=G(n),w={};return E=new fh({props:w}),n[9](E),E.$on("playersUpdate",n[6]),A=new _h({props:{isOpen:n[0],isSubmitting:n[2],submitError:Fg}}),A.$on("close",n[10]),A.$on("submit",n[7]),M=new Ih({props:{isOpen:Lg,players:n[5]}}),{c(){t=B("main"),e=B("div"),e.innerHTML='<h1 class="svelte-1m9rzzk">Drents Elftal</h1> <p class="subtitle svelte-1m9rzzk">Create your best eleven</p>',r=W(),O&&O.c(),s=W(),o=B("div"),a=B("button"),x.c(),h=W(),f=B("div"),m=B("div"),Ir(E.$$.fragment),v=W(),Ir(A.$$.fragment),C=W(),Ir(M.$$.fragment),D(e,"class","header svelte-1m9rzzk"),D(a,"class","submit-button svelte-1m9rzzk"),a.disabled=u=!n[1]||n[2],D(o,"class","controls svelte-1m9rzzk"),D(m,"class","pitch-section svelte-1m9rzzk"),D(f,"class","container svelte-1m9rzzk"),D(t,"class","svelte-1m9rzzk")},m(g,p){nt(g,t,p),k(t,e),k(t,r),O&&O.m(t,null),k(t,s),k(t,o),k(o,a),x.m(a,null),k(t,h),k(t,f),k(f,m),Cn(E,m,null),k(t,v),Cn(A,t,null),k(t,C),Cn(M,t,null),S=!0,N||(F=lt(a,"click",n[8]),N=!0)},p(g,[p]){g[3]?O||(O=wl(),O.c(),O.m(t,s)):O&&(O.d(1),O=null),G!==(G=Y(g))&&(x.d(1),x=G(g),x&&(x.c(),x.m(a,null))),(!S||p&6&&u!==(u=!g[1]||g[2]))&&(a.disabled=u);const y={};E.$set(y);const T={};p&1&&(T.isOpen=g[0]),p&4&&(T.isSubmitting=g[2]),A.$set(T)},i(g){S||(Rn(E.$$.fragment,g),Rn(A.$$.fragment,g),Rn(M.$$.fragment,g),S=!0)},o(g){wr(E.$$.fragment,g),wr(A.$$.fragment,g),wr(M.$$.fragment,g),S=!1},d(g){g&&et(t),O&&O.d(),x.d(),n[9](null),Pn(E),Pn(A),Pn(M),N=!1,F()}}}let Lg=!1,Fg=null;function xg(n,t,e){let r=!1,s=!1,o={},a=!1,u=!1,h,f={},m="",E=!1;function v(N){e(1,s=N.detail.filledPositions===11),o=N.detail.players}async function A(){if(!a){e(2,a=!0);try{await kg(o,m,E),e(3,u=!0),m="",E=!1,setTimeout(()=>{e(3,u=!1),e(2,a=!1)},3e3)}catch(N){console.error("Error submitting team:",N),e(2,a=!1)}}}const C=()=>e(0,r=!0);function M(N){Vr[N?"unshift":"push"](()=>{h=N,e(4,h)})}return[r,s,a,u,h,f,v,A,C,M,()=>e(0,r=!1)]}class Ug extends $n{constructor(t){super(),zn(this,t,xg,Og,qn,{})}}new Ug({target:document.getElementById("app")});
